<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexomnivox.aspx.cs" Inherits="prjWebCsOmnivoxAdo.indexOmnivox" %>
...
<head runat="server">
    ...
    <style>
        ...
        background-repeat: no-repeat;/*//qui ne se repete pas*/
    ...
    <div class="login">
        <form id="form1" runat="server" class="form">
            ...
            <div class="auto-style4">
                ...
                <div  >
                    <asp:Button ID="btnEntrer" CssClass="btnLogin" runat="server" onClick="btnEntrer_Click" Text="Entrer" Font-Bold="True" />
                 </div>
                 <div class="btnLink">
